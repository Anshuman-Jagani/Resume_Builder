...
const TemplateThree = ({ resumeData, colorPalette, conatinerWidth }) => {
  ...
  useEffect(() => {
    // Calculate the scale factor basec on the container width
    const actualBaseWidth = resumeRef.current.offsetWidth;
    setBaseWidth(actualBaseWidth); // Get the actual base width
    setScale(conatinerWidth / baseWidth);
  }, [conatinerWidth]);
  ...
  return (
    <div
      ...
      style={{
        transform: conatinerWidth > 0 ? `scale(${scale})` : "none",
        transformOrigin: "top left",
        width: conatinerWidth > 0 ? `${baseWidth}px` : "auto", // keep the original size so scaling works correctly
        height: "auto",
      }}
    >
