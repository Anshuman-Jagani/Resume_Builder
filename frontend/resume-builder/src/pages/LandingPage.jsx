...
const LandingPage = () => {
  ...
  const [openAuthModal, setOpenAuthMode] = useState(false);
    ...
    <div className= 'w-full min-h-full bg-white'>
      <div className='container mx-auto px-4 py-6 '>
        ...
        <header className="flex justify-between items-center mb-16">
          ...
          <button
            className=" bg-purple-100 text-sm font-semibold text-black px-7 py-2.5 rounded-lg hover:bg-gray-800 hover:text-white transition-colors cursor-pointed"
            onClick={() => setOpenAuthMode(true)}
          >
            Login/SignUp
          </button>
        </header>
